...
const WatchPage = () => {
  ...
  return (
    ...
    <div className='flex flex-col w-full'>
      ...
      <div className='flex ml-5 p-2 items-center w-1/2 border-2'>
        <img src='https://i.ytimg.com/vi/6xqNk5Sf5jo/maxresdefault.jpg' 
             alt='channel-picture' 
            className='w-14 h-14 rounded-[50%] object-left mx-2'/>
        <p className='mr-4 font-semibold text-lg'>{channelTitle}</p>  
        <button className='px-4 py-2 bg-red-700 text-white rounded-md mr-4'
                onClick={() => setSubscribe(!subscribe)}>
                {subscribe ? "Unsubscribe" : "Subscribe"}
        </button>

        <div className='flex mr-4 border-1 bg-slate-100  px-4 py-2 rounded-md cursor-pointer'>
          ...
          <p className='border-r-2 mr-1'>{Math.floor(likeCount / 1000)}K</p>  
      ...
      <div className='border-2 w-1/2 ml-5 p-2 mt-4'>
